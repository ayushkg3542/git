            ...
            <div class="row justify-content-between">
                <div class="col-md-12">
                    <div class="address pb-4 w-50 mx-auto text-center">
                        ...
                        <h5>Medicine Purchase Report</h5>
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                @foreach($purchaseInvoices as $purchaseInvoice)
                                    <tr>
                                        <th scope="row">{{ $i++ }}</th>
                                        <td>{{ Carbon\Carbon::parse($purchaseInvoice->invoice_date)->format('d-M-Y') }}
                                        </td>
                                        <td>{{ $purchaseInvoice->invoice_number }}</td>
                                        <td>{{ $purchaseInvoice->Supplier->supplier }}</td>
                                        <td>{{ $purchaseInvoice->invoice_net }}</td>
                                    </tr>
                                @endforeach
                                    <tr>
                                        <th scope="row"></th>
                                        ...
                                        <td></td>
                                        <th>Total</th>
                                        <th>{{ $purchaseInvoices->sum('invoice_net') }}</th>
                                    </tr>
                            </tbody>
                        </table>
                    </div>
